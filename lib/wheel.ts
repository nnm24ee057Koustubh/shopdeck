...
export const WHEEL_PRIZES: WheelPrize[] = [
  { label: "5% OFF", weight: 30, couponType: "PERCENT", value: 5, minOrder: 0, color: "#4f46e5", text: "#fff" },
  ...
  { label: "Better luck next time", weight: 14, couponType: null, value: 0, minOrder: 0, color: "#64748b", text: "#fff" },
  ...
  { label: "Try again soon", weight: 3, couponType: null, value: 0, minOrder: 0, color: "#334155", text: "#fff" },
